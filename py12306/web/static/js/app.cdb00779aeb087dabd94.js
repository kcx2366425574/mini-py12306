webpackJsonp([1], {
    "5ZdE": function (t, e) {
        ...
        var D = a("VU/8")(L, T, !1, function (t) {
            a("Xtbr")
        }, "data-v-2ee7b2ae", null).exports, O = {
            data: function () {
                return {
                    info: {},
                    loading_login: !1,
        ...
        var Q = [{
            ...
            component: $,
            meta: {auth: !0},
            children: [{path: "", component: D}, {path: "user", component: G}, {
                path: "log/realtime",
                component: q
            }, {path: "query", component: V}, {path: "help", component: z}, {path: "help/readme", component: X}]
        }, {path: "/login", component: U}];
        p.dispatch("LOAD_TOKEN");
        var J = new h.a({routes: Q});
