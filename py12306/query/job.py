...
from py12306.helpers.func import md5, is_main_thread, stay_second, get_interval_num
...
class Job:
    ...
    def init_data(self, info):
        ...
        self.stations = [stations] if isinstance(stations, dict) else stations
